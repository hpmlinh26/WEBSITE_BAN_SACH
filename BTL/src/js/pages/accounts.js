// accounts.js - logic trang tai khoan ca nhan (truoc o accounts.js).
import { api } from '../core/api.js';
import { money, assetPath as img } from '../core/format.js';

// ==================================================================================
// 1-8. Dieu khien UI dashboard tai khoan (dropdown, tab, mat khau, form, copy voucher)
// ==================================================================================
...
// ==================================================================================
// 9. Load don hang that tu backend / localStorage
// ==================================================================================
...
async function loadVouchers() {
  ...
  try {
    ...
    /* im lang neu khong tai duoc voucher */
  }
}
...
function activateTargetTab(targetId) {
  ...
  if (!target) return;
  document
    .querySelectorAll('.user-profile-dashboard .submenu-item, .user-profile-dashboard .sidebar-menu > .menu-item')
